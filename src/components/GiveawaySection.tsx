      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <div className="inline-flex items-center gap-2 glass text-primary px-4 py-2 rounded-full text-sm font-semibold mb-6">
              <Gift size={16} />
              Giveaway Ramadan
            </div>
          ...
          <div className="order-1 md:order-2">
            <div className="relative">
              <img
                ...
                loading="lazy"
              />
              <div className="absolute -bottom-4 -right-4 w-24 h-24 glass rounded-full flex items-center justify-center shadow-lg">
